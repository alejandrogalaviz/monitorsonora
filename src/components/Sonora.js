...
export default function Sonora() {
  ...
  return (
    <>
      <p>
        <small>
          Última actualización: 07.05 | 09:10pm | Fuente:{" "}
      ...
      <StatGrid>
        ...
        <StatBlock>
          <p style={{ fontSize: "initial" }}>+0.91%</p>
          <p>{result.toFixed(2)}% </p>
          <h3>Positivos/Pruebas</h3>
        </StatBlock>
        <StatBlock className="danger">
          <p style={{ fontSize: "initial" }}>-0.48%</p>
