  ...
  return (
    <>
      ...
      <StatGrid>
        ...
        <StatBlock>
          <p className="font-small">+436</p>
          <p>{dataTotals.tests}</p>
          <h3>Pruebas</h3>
        </StatBlock>
        <StatBlock>
          <p className="font-small">+36</p>
