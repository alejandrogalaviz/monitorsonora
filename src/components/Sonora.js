  ...
  return (
    <>
      ...
      <StatGrid>
        ...
        <StatBlock>
          <p className="font-small">+817</p>
          <p>{dataTotals.tests}</p>
          <h3>Pruebas</h3>
        </StatBlock>
        <StatBlock>
          <p className="font-small">+405</p>
          <p>{dataTotals.negatives}</p>
          <h3>Descartados</h3>
        </StatBlock>
        <StatBlock>
          <p className="font-small">-0.65%</p>
