  ...
  return (
    <>
      ...
      <StatGrid>
        ...
        <StatBlock>
          <p className="font-small">+0.76%</p>
          <p>{result.toFixed(2)}% </p>
          <h3>Positivos/Pruebas</h3>
        </StatBlock>
        <StatBlock className="danger">
          <p className="font-small">-0.28%</p>
